...
public class NBTTag {
    ...
    public static ItemStack addKey(@Nonnull ItemStack item, @Nonnull String key, String value) {
        try {
            ...
            Object tag = ((boolean) itemCraft.getClass().getMethod("hasTag").invoke(itemCraft)) ?
